        ...
        addButton.addActionListener(e -> {
            try {
                ...
                if (genericModeButton.isSelected()) {
                    ...
                    feedbackMessages.add("Added " + number + " individual particle(s) at (" + x + ", " + y + ") with angle " +
                    ...
                    int y2 = Integer.parseInt(secondYInput.getText());
                    threadManager.addParticlesWithUniformDistance(number, x, y, x2, y2, angle, velocity);
                    feedbackMessages.add(number + " particles added uniformly between (" + x + ", " + y + ") and (" + x2 + ", " + y2 + ").");
